                ...
                >
                  <div className="flip-card-inner">
                    ...
                    <div className="flip-card-back">
                      <div className="polaroid bg-gray-800 text-white h-full flex flex-col overflow-hidden">
                        {/* Back Header */}
                        <div className="flex justify-between items-start mb-3 flex-shrink-0">
                          <h3 className="text-lg font-bold text-blue-400 line-clamp-1 flex-1 mr-2">{title}</h3>
                          <button 
                            className="p-1.5 bg-gray-700 rounded-full hover:bg-gray-600 transition-colors flex-shrink-0"
                        ...
                        <div className="flex-1 overflow-y-auto overflow-x-hidden pr-1 mb-3 custom-scrollbar">
                          {/* Description */}
                          <div className="mb-4">
                            <h4 className="text-sm font-semibold text-blue-300 mb-2">📝 Description</h4>
                            <p className="text-gray-300 text-sm leading-relaxed break-words">{description}</p>
                          </div>
                            ...
                            <div className="mb-4">
                              ...
                              <div className="flex flex-wrap gap-1.5">
                                {technologies.map((tech, techIndex) => (
                                  <span 
                                    key={techIndex} 
                                    className="px-2 py-1 bg-blue-900/50 text-blue-300 text-xs rounded-full border border-blue-500/30 whitespace-nowrap"
                                  >
                                    {tech}
                                  </span>
                                ))}
                        ...
                        <div className="flex space-x-2 flex-shrink-0">
                          {githubUrl && (
                            <a
                              ...
                              className="flex-1 inline-flex items-center justify-center px-2 py-2 bg-gray-700 hover:bg-gray-600 rounded-lg text-sm font-medium transition-colors"
                            >
                          ...
                          {liveUrl && (
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex-1 inline-flex items-center justify-center px-2 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg text-sm font-medium transition-colors"
                            >
